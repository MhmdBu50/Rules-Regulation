document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        ...
        "admin-chart-legend-student-guides": "Student guides & templates", // Added based on typical content
        ...
        "admin-stats-viewed-times": "Viewed: {0} times", // Placeholder for dynamic number
        ...
        "admin-search-placeholder": "Search by Name/ID...",
        ...
        "admin-stats-viewed-times": "تمت المشاهدة: {0} مرة",
        ...
        "admin-search-placeholder": "البحث بالاسم/الرقم التعريفي...",
        ...
        "admin-table-form-attach-pdf-label": "إرفاق ملف PDF",
