document.addEventListener("DOMContentLoaded", () => {
    ...
    const translations = {
        ...
        "assign-new-editor-btn-label": "Assign New Editor",
    ...
    "activityLog-entity-regulation": "REGULATION",
    "activityLog-entity-notification": "NOTIFICATION",
    "activityLog-entity-service": "SERVICE",
    "activityLog-entity-user": "USER",
    "activityLog-entity-name-unknown": "Unknown",
    
    // Activity Log Field Names
    "activity-field-regulationName": "Regulation Name",
    "activity-field-regulationNameAr": "Regulation Name (Arabic)",
    "activity-field-department": "Department",
    "activity-field-version": "Version",
    "activity-field-versionDate": "Version Date",
    "activity-field-approvalDate": "Approval Date",
    "activity-field-approvingEntity": "Approving Entity",
    "activity-field-approvingEntityAr": "Approving Entity (Arabic)",
    "activity-field-description": "Description",
    "activity-field-descriptionAr": "Description (Arabic)",
    "activity-field-documentType": "Document Type",
    "activity-field-notes": "Notes",
    "activity-field-notesAr": "Notes (Arabic)",
    ...
    "close" : "Close",
    // Activity Details Modal Body Translations
    ...
    "new-added-fields": "New/Added fields",
    "removed-fields": "Removed fields",
    "added-data": "Added Data",
    "deleted-data": "Deleted Data",
    "before-changes": "Before Changes",
    "original-values-highlighted": "(Original values highlighted)",
    "after-changes": "After Changes",
    "new-values-highlighted": "(New values highlighted)",
    "no-detailed-change-info": "No detailed change information available for this activity.",
    "no-data-available": "No data available",
    "loading": "Loading...",
    "loading-activity-details": "Loading activity details...",
    "please-wait-fetching": "Please wait while we fetch the information",
    "error-loading-activity-details": "Error Loading Activity Details",
    "error-details": "Error Details:",
    "troubleshooting": "Troubleshooting:",
    "check-log-id-exists": "Check if the Log ID exists in the database",
    "verify-network-connection": "Verify your network connection",
    "try-refreshing-page": "Try refreshing the page",
    "contact-admin-if-persists": "Contact system administrator if the problem persists",
        ...
        "assign-new-editor-btn-label": "تعيين محرر جديد",
   ...
   "btn-back-admin": "العودة إلى لوحة التحكم",
    ...
    "modified-fields": "الحقول المعدّلة",
    "new-added-fields": "الحقول الجديدة/المضافة",
    "removed-fields": "الحقول المحذوفة",
    "added-data": "البيانات المضافة",
    "deleted-data": "البيانات المحذوفة",
    "before-changes": "قبل التغييرات",
    "original-values-highlighted": "(القيم الأصلية مميزة)",
    "after-changes": "بعد التغييرات",
    "new-values-highlighted": "(القيم الجديدة مميزة)",
    "no-detailed-change-info": "لا تتوفر معلومات تفصيلية عن التغيير لهذا النشاط.",
    "no-data-available": "لا تتوفر بيانات",
    "loading": "جار التحميل...",
    "loading-activity-details": "جار تحميل تفاصيل النشاط...",
    "please-wait-fetching": "يرجى الانتظار أثناء جلب المعلومات",
    "error-loading-activity-details": "خطأ في تحميل تفاصيل النشاط",
    "error-details": "تفاصيل الخطأ:",
    "troubleshooting": "استكشاف الأخطاء:",
    "check-log-id-exists": "تحقق من وجود معرف السجل في قاعدة البيانات",
    "verify-network-connection": "تحقق من اتصال الشبكة",
    "try-refreshing-page": "جرب إعادة تحديث الصفحة",
    "contact-admin-if-persists": "اتصل بمدير النظام إذا استمرت المشكلة",
    "activityLog-role-editor": "محرر",
    ...
    "activityLog-entity-regulation": "لائحة",
    "activityLog-entity-notification": "إشعار",
    "activityLog-entity-service": "خدمة",
    "activityLog-entity-user": "مستخدم",
    ...
    // Activity Log Field Names (Arabic)
    "activity-field-regulationName": "اسم اللائحة",
    "activity-field-regulationNameAr": "اسم اللائحة (عربي)",
    "activity-field-department": "القسم",
    "activity-field-version": "النسخة",
    "activity-field-versionDate": "تاريخ النسخة",
    "activity-field-approvalDate": "تاريخ الموافقة",
    "activity-field-approvingEntity": "الجهة المعتمدة",
    "activity-field-approvingEntityAr": "الجهة المعتمدة (عربي)",
    "activity-field-description": "الوصف",
    "activity-field-descriptionAr": "الوصف (عربي)",
    "activity-field-documentType": "نوع الوثيقة",
    "activity-field-notes": "الملاحظات",
    "activity-field-notesAr": "الملاحظات (عربي)",
